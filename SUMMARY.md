...
* [Пользовательское поведение](commands/custom-behavior/README.md)
  ...
  * [Глобальные переменные](commands/custom-behavior/global-variables.md)
...
* [Социальные оповещения](guides/subscriptions.md)
...
* [Список изменений](other/change-log.md)
* [Условия использования](other/terms.md)
* [Конфиденциальность](other/privacy.md)
